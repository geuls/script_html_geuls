def lannisters():
    ...
    <html>
    <head>
    <title>Джейме Ланнистер</title>
    </head>
    <body>
    <body bgcolor="f15f0f30">
    <H1 align="left">Джейме Ланнистер</H1>
    <HR>
    <img src="Джейме_7x04_инфобокс.jpg" align="center" width="100%" height="70%" hspace="10" vspace="15">
    <h1> Сир Джейме Ланнистер — представитель великого дома Ланнистеров. Ста
рший сын Тайви
...
Томмене. Ныне
командует армией Ланнистеров.<br>
...
о кличут «Царе
убийцей», что в глубине души задевает Джейме.<br> Помимо убийства короля, Дж
ейме известен
...
тая, что это н
е его путь. <br> Хоть Джейме и является старшим сыном Тайвина Ланнистера, он
 не может унас
...
меч, чтобы сру
бить ей голову, а не идёт на переговоры и не плетёт интриги.<br>
...
оего младшего
брата. <br>Также Джейме - единственный член семьи основной ветви Ланнистеров
 (Тайвина и его трёх детей), кому удалось сохранить нормальные отношения со
всеми. Серсея и Тирион терпе
ть не могут друг друга, но оба хорошо относятся к Джейме.<br>
...
<br> По понятным причинам Джейме не может вести себя как отец со своими биол
